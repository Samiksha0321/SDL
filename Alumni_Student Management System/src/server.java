	...
	public static void main(String args[]) throws Exception { 
        ...
        while (true) { 
        	...
        	case "alumni sign-in": 	
        		...
        		ArrayList<String> alumni_signin = new ArrayList<String>();
        		...
        		System.out.println("..Verifying..");
        			...
        			ResultSet alumn = st.executeQuery("select password from alumni where EMAIL='&al_name'");
        			int passw = Integer.parseInt(alumn.getString(1));
        			System.out.println("2");
					//System.out.println("value is: " + alumni.toString());
        			if(passw == pass)
					{
							System.out.printf("Account verified!\n");		
		        			toClient.println("Verified");
